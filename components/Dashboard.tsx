  ...
  return (
    <div className="p-8 space-y-8 animate-fade-in pb-24">
      <header>
        ...
        <p className="text-gray-400">Welcome back! Here is your streaming activity summary.</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-[#1a1a1a] p-6 rounded-2xl border border-gray-800">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-gray-400 text-sm font-medium">Total Watched</p>
              <h3 className="text-4xl font-bold text-white mt-2">{stats.totalVideos}</h3>
            </div>
        ...
        <div className="bg-[#1a1a1a] p-6 rounded-2xl border border-gray-800">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-4xl font-bold text-white mt-2">{stats.uniqueChannels}</h3>
            </div>
        ...
        <div className="bg-[#1a1a1a] p-6 rounded-2xl border border-gray-800">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-4xl font-bold text-white mt-2 truncate max-w-[150px]">
